...
-- Entity information
ENT.PrintName    = "Authority MG Rounds"
ENT.Author       = "Buu342"
ENT.Instructions = "Standard issue Enforcer rounds, all kills and no frills."
ENT.Category     = "RAGE"

-- Model
ENT.Model = "models/weapons/w_rage_machinegun_mag1.mdl"
