...
-- Entity information
ENT.PrintName    = "Mind Control Bolts"
ENT.Author       = "Buu342"
ENT.Instructions = "Control your victim until they explode. A party favorite."
ENT.Category     = "RAGE"

-- Model
ENT.Model = "models/props/rage/pickup_mindcontrol.mdl"
...
-- Allow the entity to be spawned
ENT.AmmoType   = "ammo_rage_mindcontrol"
ENT.AmmoAmount = 3
