...
-- Entity information
ENT.PrintName    = "Dynamite Bolts"
ENT.Author       = "Buu342"
ENT.Instructions = "When you need some dynamite delivered really quickly."
ENT.Category     = "RAGE"

-- Model
ENT.Model = "models/props/rage/pickup_tnt.mdl"
